          ...
          <div class="row"> 
            ...
            <div class="col-md-8">
              <div class="text-sec">
                ...
                <p>We offer a suite of products, custom-tailored to meet the needs of each hospital. Our integrated solutions enable hospitals to manage patient information, track financials, manage staff, and more. Our products are designed to be intuitive, easy to use and reliable, so that hospitals can focus their time and resources on delivering quality care to their patients.</p>
                <ul class="row">
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> EMERGENCY CASE</h6>
                    <p>This application provides access to emergency medical services such as appointment booking services, doctors consultency services, and others medical services.The website also provides an online library of medical information and resources for doctors to use. 
                    </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> QUALIFIED DOCTORS</h6>
                    <p>This application provides a variety of services to qualified doctors. The website also provides a secure portal for doctors to communicate with their patients and other healthcare professionals. Doctors can also access their patient’s medical history, review their lab results, and review their patient’s information. </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> ONLINE APPOINTMENT</h6>
                    <p>Online Appointment services allow users to book appointments with hospitals and healthcare professionals from the comfort of their homes. This Website provides comprehensive online appointment scheduling solutions for hospitals and clinics.</p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> FREE MEDICAL COUNSELING</h6>
                    <p>Patients can access free medical counseling services from the comfort of their homes or from anywhere with an internet connection. Patients can book appointments with doctors and other healthcare professionals, get health advice, and receive personalized treatment plans.</p>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>This website provides a platform for Eye Specialists to communicate with their patients and answer any questions they may have.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>This system allows for the tracking and management of operating room utilization. It also enables hospitals to set utilization goals and generate reports.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>With the help of this website, hospitals can keep track of the vital signs of their ICU patients in real-time, ensuring that they receive the best care possible. </p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>This website provides qualified doctors with a range of services designed to make their work easier and more efficient.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>This website provides comprehensive services for heart problems from diagnosis and treatment to recovery and rehabilitation.</p>
                </div>
              </article>
            </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>By this system, medical staffs are able to monitor patient meals and nutrition, as well as track any changes in the patient diet and lifestyle.</p>
                </div>
              </article>
            </div>
          </div>
